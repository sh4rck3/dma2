...
defineProps({
    ...
    carteira: String,
    justDuplicidade: String,
})
</script>

<template>
  <div class="flex justify-center p-4">
        <button id="button" type="button"><Icon name="eye" class="w-5 h-5" /></button>
    </div>
        ...
        <div class="relative w-full h-full max-w-2xl md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 space-y-6">
                    <b>Código do Escritório: </b> {{ codEscritorio }} <br>
                    <b>Carteira: </b> {{ carteira }} <br>
                    <b>Justificativa de duplicaidade: </b> {{ justDuplicidade }} <br>
                </div>
            </div>
        </div>
    </div>
