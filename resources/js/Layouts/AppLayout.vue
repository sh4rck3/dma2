                                ...
                                <Dropdown align="right" width="60" :active="route().current('useradm')">
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <!-- Team Settings -->
                                            <DropdownLink  :href="route('smsadm')">
                                                Enviar Sms
                                            </DropdownLink>

                                            <DropdownLink  :href="route('smsadmhistory')">
                                                Histórico
                                            </DropdownLink>

                                            <DropdownLink  :href="route('smsadmremessa')">
                                                Remessas
                                            </DropdownLink>
                                        </div>
                                    </template>
                                ...
                                <Dropdown align="right" width="60" :active="route().current('useradm')">
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <!-- Team Settings -->
                                            <DropdownLink  :href="route('useradm')">
                                                Usuarios
                                            </DropdownLink>
                                ...
                                <Dropdown align="right" width="60" :active="route().current('useradm')">
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            <!-- user Management -->
                                            <div class="block px-4 py-2 text-xs text-gray-400">
                                                Reuniões e videoconferencias
                                            </div>

                                            <!-- Team Settings -->
                                            <DropdownLink  :href="route('meeting')">
                                                Marcar uma reunião
                                            </DropdownLink>
